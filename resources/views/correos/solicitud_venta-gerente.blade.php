...
<html lang="es" dir="ltr">
  ...
  <body style="margin: 0; padding: 0;">
      ...
      <tr>
       <td colspan="4">
         <b><p style="font-size: 14pt;">¡Buenas! Le notificamos que se ha solicitado la compra de animales. Aqui dejaremos todos los datos pertinentes.</p></b>
       </td>
      </tr>
      <tr>
        <td colspan="4">
      ...
      @foreach ($detalles_animales as $animal_en_venta)
        ...
        <tr>
          ...
          <td valign="top" style="padding:5px;">
            @if ($animal_en_venta->color)
              {{ $animal_en_venta->color }}
            @else
              Desconocido
            @endif
          </td>
