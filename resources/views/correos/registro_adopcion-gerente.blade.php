...
<html lang="es" dir="ltr">
  ...
  <body style="margin: 0; padding: 0;">
      ...
      <tr>
       <td colspan="4">
         <b><p style="font-size: 14pt;">¡Buenas! Le notificamos que se han registrado correctamente los animales a para poner en adopción. Aqui dejaremos todos los datos pertinentes.</p></b>
       </td>
      </tr>
      <tr style="background-color:#F08080;">
        <td colspan="4" style="padding:5px; text-align:center;">
          <p style="font-size: 12pt; color:white;">Estos son los animales que se quieren adoptar y la persona que los pusieron en adopción:</p>
        </td>
      </tr>
      <tr>
      ...
      @if (!empty($enc_adopcion->observaciones_dueño))
      <tr>
        <td colspan="2" valign="top" style="padding:5px;">Observaciones:</td>
        <td colspan="2" valign="top" style="padding:5px;">{{ $enc_adopcion->observaciones_dueño }}</td>
      </tr>
      @endif
      <tr style="background-color:#20B2AA;">
        <td colspan="4" style="padding:5px; text-align:center;">
          <p style="font-size: 12pt; color:white;">Estos son los animales que se quieren adoptar</p>
        </td>
      </tr>
