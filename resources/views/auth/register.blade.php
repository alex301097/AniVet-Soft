              ...
              <div class="card-body px-lg-4 py-lg-4">
                ...
                <form role="form" method="POST" action="{{ route('register') }}">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="codigo"><h5><i style="color:red;" class="fas fa-asterisk"></i>&nbsp;Nombre de usuario</h5></label>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="nacionalidad"><h5><i style="color:red;" class="fas fa-asterisk"></i>&nbsp;Nacionalidad</h5></label>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-sm form-control-alternative {{ $errors->has('telefono') ? ' is-invalid' : '' }}" value="{{ old('telefono') }}"  id="telefono" name="telefono" placeholder="Telefono">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <small for="password" id="passwordHelpBlock" class="form-text text-muted">
                        ...
                        Tu contraseña debe tener al menos una mayúscula, una minúscula, un carácter, un número y 10 dígitos como mínimo y 50 dígitos como máximo.
                      </small>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
