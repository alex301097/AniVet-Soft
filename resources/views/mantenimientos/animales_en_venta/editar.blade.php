                    ...
                    <div class="form-group">
                      <label for="fecha_nacimiento"><h5>Fecha de nacimiento</h5></label>
                        <div class="input-group">
                            <input type="date" class="form-control form-control-sm" id="fecha_nacimiento" name="fecha_nacimiento" placeholder="Fecha de nacimiento" value="{{$animal->fecha_nacimiento}}">
                        </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" id="estado" name="estado">
                        <option value="">Seleccione una opción</option>
                        <option value="En venta" {{($animal->estado == "En venta")?"selected":""}}>En venta</option>
                        <option value="En adopción" {{($animal->estado == "En adopción")?"selected":""}}>En adopción</option>
                      </select>
