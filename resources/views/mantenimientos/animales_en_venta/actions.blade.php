<div class="text-center">
  <a type="button" class="btn btn-sm bg-navy"
  href="#" title="Click para añadir las imagenes del animal" id="añadir_imagenes" name="añadir_imagenes"
  data-toggle="modal" data-target="#modal-añadir" data-id="{{$id}}">
  &nbsp;<i class="far fa-images"></i>&nbsp;
  </a>

  <a type="button" class="btn btn-info btn-sm"
  title="Click para mostrar los detalles del animal"
