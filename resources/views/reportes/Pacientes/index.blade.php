        ...
        <div class="row">
            <div class="col-md-4">
              ...
              <button type="submit" class="btn btn-sm btn-success pull-left" style="max-width:300px;"
                ...
                title="Click para generar el reporte en PDF de los pacientes.">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control form-control-sm" id="estado" name="estado" style="max-width:250px;">
                  <option value="habilitados">Pacientes habilitadas</option>
                  <option value="deshabilitados">Pacientes deshabilitadas</option>
                </select>
              </div>
            </div>
        </div>
         ...
         $(function() {
             ...
             $('input[name="datefilter"]').on('apply.daterangepicker', function(ev, picker) {
               var table = $('#pacientes').DataTable();
                 var ruta = "{{ url('api/reporte_pacientes/:min/:max/:estado') }}";
           ...
           $('#generar_reporte').click(function () {
             if(!$('#rango_fechas').val()){
                 var ruta = "{{ route('pacientes-pdf',['0','0',':estado']) }}";
                 ruta = ruta.replace(':estado', $("#estado").val());

                 window.open(ruta, '_blank');
             }else {
               var ruta = "{{ route('pacientes-pdf',[':min',':max',':estado']) }}";
